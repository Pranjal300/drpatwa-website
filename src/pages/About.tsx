...
const About = () => {
  ...
  const timelineTitleRef = useScrollReveal();
  const setTimelineRef = useScrollRevealList(timeline.length);
  ...
  return (
    <>
      ...
      <section className="bg-secondary py-16 lg:py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div ref={quoteRef} className="grid lg:grid-cols-2 gap-10 items-center">
