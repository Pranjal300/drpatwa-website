  ...
  <>
    ...
    <section className="py-16 lg:py-20">
      <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
        <h2 className="text-2xl lg:text-3xl font-serif font-bold text-center mb-12">Education & Career</h2>
        <div className="space-y-8">
          {timeline.map((t, i) => (
            ...
            >
              ...
              <div className="pb-6">
                <span className="text-xs font-semibold text-accent">{t.year}</span>
                <h3 className="font-serif font-semibold text-lg mt-1">{t.title}</h3>
